...
def default_trainer(
    ...
    cl_strategy, save_path, episode_idx, log_stream=None, validloader=None):
    
    model = train_fn(args, dataloader, model, validloader=validloader, criterion=criterion, log_stream=log_stream)
